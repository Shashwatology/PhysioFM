...
## Experiment Details
- **Experiment Name**: EXP08A_TargetNorm
- **Run Date**: 2026-07-14 11:43:27
- **Random Seed**: 42
...
- **Torchvision Version**: 11.8
- **Timm Version**: 1.0.27
- **Git Commit**: Not available (Not a git repository or git not installed)

## Hardware
- **CPU**: Intel64 Family 6 Model 85 Stepping 7, GenuineIntel
- **GPU**: NVIDIA RTX A2000 12GB (12.88 GB)
- **CUDA Version**: 11.8
...
embed_dim: 256
epochs: 10
exp_name: EXP08A_TargetNorm
learning_rate: 0.001
limit_subjects: null
model_name: PhysioFM
normalize_hr_targets: true
patience: 15
project: Physiological-Foundation-Model
seed: 42
seq_len: 150
stds_alpha_init: 0.0
stds_fusion_mode: concat
tracking: wandb
use_ccc_loss: false
