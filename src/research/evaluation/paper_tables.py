...
def generate_paper_tables(report_dir: str):
    """
    Generates publication-ready Markdown tables for the final manuscript.
    These can easily be copied into LaTeX or a Word document.
    """
    os.makedirs(report_dir, exist_ok=True)
    
    # Table I: Dataset Summary
    table_i = """## Table I: Dataset Summary
...
"""
    ...
    table_ii = """## Table II: Implementation Details
...
"""
    ...
    # Table III: SOTA Comparison
    table_iii = """## Table III: Comparison with State-of-the-Art on UBFC-rPPG
...
"""
    ...
    # Table IV: Ablations
    table_iv = """## Table IV: Architectural Ablation Study (UBFC-rPPG)
...
"""
    ...
    table_v = """## Table V: Model Efficiency and Computational Cost
...
"""
    ...
    md_content = f"# Publication Tables\n\n{table_i}\n{table_ii}\n{table_iii}\n{table_iv}\n{table_v}"
    
    out_path = os.path.join(report_dir, "publication_tables.md")
    with open(out_path, "w", encoding="utf-8") as f:
        f.write(md_content)
        
    print(f"Publication tables generated at {out_path}")

if __name__ == "__main__":
    generate_paper_tables(r"paper\tables")
